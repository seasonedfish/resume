...
\begin{labeling}{Programming Languages}
    \item [Languages] Python, Java, JavaScript, HTML/CSS, Bash, C, C++, Haskell, PHP, SQL, R
...
\begin{doutline}
    ...
    \hfill Oct.\ 2022
        \2 Developed, in a team of two, the frontend for the calendar using JavaScript, HTML, and CSS
        \2 Set up an EC2 instance and configured file permissions for seamless collaboration
