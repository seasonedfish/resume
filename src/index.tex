...
\begin{doutline}
    \1 (Advanced) Python, Java; (Basic) Bash, C, Haskell, PHP
    \1 \LaTeX, HTML, Markdown, reStructuredText
    \1  Pandas, Matplotlib, Gson, Apache Commons CLI
    \1 Git, JUnit, Pytest, Maven, Poetry, GitHub Actions, Code Climate, LGTM
    \1 Windows, macOS, Linux (KDE Plasma), UNIX command line
\end{doutline}
\end{minipage}
...
\section{Experience}
\begin{doutline}
    \1[The lab of Dr. Feifan Liu, UMass Chan Medical School] / SWE Intern \hfill 2020
