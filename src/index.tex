...
\begin{labeling}{Languages O}
    ...
    \item [Libraries] Pandas, Matplotlib, Gson, Apache Commons CLI, Polars, Beautiful Soup, Chi
    \item [Tools] Git, JUnit, Pytest, Maven, Poetry, GitHub Actions, Coveralls, Nix, GNU Parallel, CMake
    \item [Platforms] Windows, macOS, AWS EC2, AWS Lambda, Oracle Cloud Infrastructure, Cloudflare, IBM LSF
\end{labeling}
...
\section{Projects}
\begin{doutline}
    \1[Voting app] / Go, Chi, MongoDB, MongoDB Atlas
    \hfill Nov.\ 2022--Dec.\ 2022
        \2 Built, in a team of two, a web app in which users can vote for Student Union candidates
            \3 Set up a database on MongoDB Atlas
            \3 Wrote, in Go, the app's REST API, and the routing logic to serve both backend and React frontend
            \3 Followed the MVC design pattern; designed separate model and controller components
