...
\begin{doutline}
    ...
    \1[Washington University in St.\ Louis] \textsc{gpa} 3.91/4.00
...
\section{Projects}
\begin{doutline}
    \1[Voting app] / Go, Chi, Mongo\textsc{db}, Mongo\textsc{db} Atlas, Mongo\textsc{db} Go Driver
    ...
    \1[Coding blog] / Jekyll, \textsc{html}, Liquid, \textsc{scss}, Cloudflare Pages
    ...
    \1[Calendar web app] / Amazon \textsc{ec2}, Apache, JavaScript, \textsc{html}, \textsc{css}
    \hfill Oct.\ 2022
