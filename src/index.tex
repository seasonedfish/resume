...
\0 \section{Skills}
    \1[Programming Languages] \hfill (Advanced) Python, Java; (Basic) Bash, C, Haskell, PHP 
    \1[Markup Languages] \hfill \LaTeX, HTML, Markdown, reStructuredText 
    ...
    \1[Operating Systems] \hfill Windows, macOS, Linux (KDE Plasma), UNIX command line 
